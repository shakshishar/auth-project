...
export default function page(){
    return(
        ...
        <div className="relative py-3 sm:max-w-xl sm:mx-auto">
            ...
            {/* div for the whole form or input field */}
        <div className="divide-y divide-gray-200 flex flex-col">
          ...
          {/* div for the email address */}
            ...
            <div class="relative">
              <button class="bg-cyan-500 text-white justify-center rounded-md px-2 py-1">click here</button>
            </div>
          </div>
        </div>
        </div>

            {/* div for the sign in with google button */}
